...
class LeadConvertForm extends Component {
  ...
  */
  ...
  fetchRegions = (inputValue) => {
    return this.getOptions('cf_contact_khu_vuc', inputValue)
  }
    ...
    return (
      <div className="form-convert-field">
        ...
        <fieldset className="field-group">
          ...
          <Field label="Số điện thoại" name="cf_mobile" val={this.props.data.mobile} isRequired changeHandler={this.handleChange} />
          <Field label="Primary Email" name="cf_email" val={this.props.data.cf_email} changeHandler={this.handleChange} isRequired/>
          ...
          <div className="form-convert-wrapper-field" id="industry-wrapper">
            <label className="form-convert-label-field">
  ...
  render() {
    ...
    return (
      <div className="form-convert-wrapper-field" id={this.props.name + "-wrapper"}>
        ...
        {/*<label className="form-convert-label-error">Không được để trống</label>*/}
        {/*<label className="form-convert-label-error">Không đúng định dạng</label>*/}
      </div>
    )
  }
}
